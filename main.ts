...
console.log(chalk.greenBright(`you Successfully converted`),
chalk.rgb(0,255,255) (`${amount} ${userInput.convertFrom}`), 
chalk.greenBright(`into`),
chalk.rgb(102,102,255)(`${convertedAmount.toFixed(2)} ${userInput.convertTo}.\n`));
